      ...
      <section id="projects" className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition transform hover:-translate-y-2">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Platform to transfer information securely using a combination of
              Cryptography, Steganography and Facial Recognition.
            </p>
            <div className="flex flex-wrap gap-2 text-xs">
              <span className="bg-gray-700 px-2 py-1 rounded-full">
                Computer Vision
        ...
        <div className="flex flex-col md:flex-row items-center justify-center p-6 bg-gray-800 rounded-lg shadow-lg">
          ...
          <div className="text-center md:text-left">
            <h4 className="text-xl font-semibold text-green-400">
              "Encrypted Transfer of Confidential Information Using
              Steganography and Identity Verification Using Face Data"
            </h4>
            <p className="text-gray-400 text-sm italic mt-1">
              Artificial Intelligence and Evolutionary Computations in
              Engineering Systems, Vol. 1056, pp. 155–166 (2020)
            </p>
            <p className="text-gray-300 text-sm mt-2">
              <span className="font-semibold">Abstract:</span> Information
              security has become a significant part of data communication. In
              order to address this crucial point in data communication to
              secure the confidential data, steganography and cryptography can
              be combined to give better results. Steganography is a practice to
              hide any confidential or sensitive information into another
              information that plays as the cover for the information, adding a
              layer of security on top of science of secret writing, known as
              cryptography. In this paper, we discuss an improved LSB
              steganography technique to optimize the algorithm hiding the bits
              in different channels selected dynamically using key. We further
              propose a platform leveraging cryptographic algorithms and
              verification using face data in pipeline to help keep data more
              secure.
            </p>
            <a
